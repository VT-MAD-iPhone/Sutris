...
- (void) newActiveBlock
{
    ...
    self.activeBlock = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"SudokuCell%i.png", model.activeBlock.value]]];
    ...
    [self.view addSubview:self.activeBlock];
}
